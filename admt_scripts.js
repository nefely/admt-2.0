...
admt_start = () => {
	...
	$(document).ready(function(){
	    ...
	    params_object.subid = `{subid}` // params_object.subid = document?.cookie?.split(";")?.filter((item)=> item.includes("_subid="))?.[0]?.split("=")?.[1]
	    params_object.ckid_sorc = getURLParameter(window.location.href, 'ckid_sorc') ? getURLParameter(window.location.href, 'ckid_sorc') : `{subid}`
	    params_object.site_name = window.location.host
	    params_object.sorc_land_id = `{landing_id}`
	    ...
	    // rewrire this params if need
	        ...
	        params_object.vertical = "MY_VERTICAL"
	        params_object.source = getURLParameter(window.location.href, 'sorc_id') ? getURLParameter(window.location.href, 'sorc_id') : "MY_SOURCE"
	    ...
	    window.formFinalLinkObject = () => {
	        setTimeout(()=>{
	            // console.log("formFinalLinkObject") 
	            // general
	            ...
	            __sorc_land_id = params_object.sorc_land_id ? `sorc_land_id=${params_object.sorc_land_id}_{campaign_id}_{stream_id}` : `sorc_land_id=`
	            ...
	            // in_page_push 
	                ...
	                if (params_object?.start_link_object?.in_page_push?.includes("?")) {
	                    params_object.final_link_object.in_page_push = `${params_object.start_link_object.in_page_push}&${in_page_push__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inpp&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.in_page_push = `${params_object.start_link_object.in_page_push}?${in_page_push__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inpp&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	            ...
	            // comebacker 
	                ...
	                if (params_object?.start_link_object?.comebacker?.includes("?")) {
	                    params_object.final_link_object.comebacker = `${params_object.start_link_object.comebacker}&${comebacker__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=expp&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.comebacker = `${params_object.start_link_object.comebacker}?${comebacker__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=expp&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	            ...
	            // inactive_tab_redirect 
	                ...
	                if (params_object?.start_link_object?.inactive_tab_redirect?.includes("?")) {
	                    params_object.final_link_object.inactive_tab_redirect = `${params_object.start_link_object.inactive_tab_redirect}&${inactive_tab_redirect__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inact_rd&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.inactive_tab_redirect = `${params_object.start_link_object.inactive_tab_redirect}?${inactive_tab_redirect__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inact_rd&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	            ...
	            // inactive_tab_banner 
	                ...
	                if (params_object?.start_link_object?.inactive_tab_banner?.includes("?")) {
	                    params_object.final_link_object.inactive_tab_banner = `${params_object.start_link_object.inactive_tab_banner}&${inactive_tab_banner__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inact_b&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.inactive_tab_banner = `${params_object.start_link_object.inactive_tab_banner}?${inactive_tab_banner__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=inact_b&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	            ...
	            // back_button 
	                ...
	                if (params_object?.start_link_object?.back_button?.includes("?")) {
	                    params_object.final_link_object.back_button = `${params_object.start_link_object.back_button}&${back_button__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=bb&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.back_button = `${params_object.start_link_object.back_button}?${back_button__crid}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=bb&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	            ...
	            // second_offer 
	                ...
	                if (params_object?.start_link_object?.second_offer?.includes("?")) {
	                    params_object.final_link_object.second_offer = `${params_object.start_link_object.second_offer}&${__aid_sorc}&${__vertical}&${__sorc_id}&admt=2nd&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                } else {
	                    params_object.final_link_object.second_offer = `${params_object.start_link_object.second_offer}?${__aid_sorc}&${__vertical}&${__sorc_id}&admt=2nd&${__sorc_land_id}&${__sorc_ref}&${__ps_ckid}&${__ckid_sorc}&${__a}&${__sx}&${__intst}&${__frq}&${__flw}`
	                }
	...
	if ( admt_array.filter(item => item.type == "in_page_push" && item.active == true)[0] ) {
		console.log("admt type inpp - activated")
		$(document).ready(function(){
			...
			<div id="in-page-push">
				...
				<div class="in-page-push-text">
					...
					<div class="in-page-push-button">
						<a class="in-page-push-go" target="_blank">Reply Now</a>
					</div>
				</div>
			</div>
			`
			    ...
			    <div class="comebacker-wrapper">    
			      ...
			      <div class="comebacker-content" id="comebacker-content">
			        ...
			        <div class="comebacker-button">
			          <a class="comebacker-go" target="_blank">Reply Now</a>
			        </div>
			      </div>
			    </div>
		  	</div>
	...
	if ( admt_array.filter(item => item.type == "inactive_tab" && item.active == true)[0] ) {
		console.log("admt type inact_rd - activated")
		$(document).ready(function(){
			document.querySelector("body").insertAdjacentHTML("beforeend", 
	...
	if ( admt_array.filter(item => item.type == "inactive_banner" && item.active == true)[0] ) {
		console.log("admt type inact_b - activated")
		$(document).ready(function(){
		  	document.querySelector("body").insertAdjacentHTML("beforeend", 
			`
			    ...
			    <div class="inactive-tab-banner-wrapper">   
			      ...
			      <div class="inactive-tab-banner-content" id="inactive-tab-banner-content">
			        ...
			        <div class="inactive-tab-banner-button">
			          <a class="inactive-tab-banner-go" target="_blank">Reply Now</a>
			        </div>
			      </div>
			    </div>
		  	</div>
			...
			inactive_tab_banner_get_random_object = () => {
				...
				// $("#inactive_tab_banner-age").text(inactive_tab_banner_chousen_object.age)
	...
	if ( admt_array.filter(item => item.type == "second_offer" && item.active == true)[0] ) {
		console.log("admt type 2nd - activated")
		$(document).ready(function(){
			document.querySelector("body").insertAdjacentHTML("beforeend", 
	...
	if ( admt_array.filter(item => item.type == "back_button" && item.active == true)[0] ) {
		console.log("admt type bb - activated")
		$(document).ready(function(){
			document.querySelector("body").insertAdjacentHTML("beforeend", 
						...
						prompts: [
							{
								...
								text: {
									...
									acceptButton: params_object.web_push_notification_setting.acceptButton,
									/* cancelButton limited to 15 characters */
									cancelButton: params_object.web_push_notification_setting.cancelButton
								},
								delay: {
									pageViews: 1,
									timeDelay: 10
